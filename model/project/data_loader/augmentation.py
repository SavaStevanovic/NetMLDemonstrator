    ...
    def __call__(self, image, labels):
        ...
        for l in labels:
            ...
            if  target[i,  0, box_position[1], box_position[0]]== 0:
                ...
                target[i,  1, box_position[1], box_position[0]] = np.log(max(bbox[2], 1)/self.prior_box_size*self.ratios[i])
                target[i,  2, box_position[1], box_position[0]] = np.log(max(bbox[3], 1)/self.prior_box_size)
