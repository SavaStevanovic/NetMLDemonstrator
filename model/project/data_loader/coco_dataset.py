...
class CocoDetectionDatasetProvider():
    def __init__(self, annDir='/Data/Coco/', batch_size=1, train_transforms=None, val_transforms=None, classes=None, th_count=mu.cpu_count(), ratios=[1.0]):
        if classes is None:
        ...
        if th_count==1:
            self.trainset.ids      = self.trainset.ids[:10]
